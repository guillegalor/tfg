...
% TABLAS, GRÁFICOS, LISTADOS DE CÓDIGO y ALGORITMOS
% ---------------------------------------------------------------------
\usepackage{booktabs}
...
\usepackage[spanish,ruled,vlined]{algorithm2e} % Para la inclusión de algoritmos
...
\newcommand{\miTitulo}{Algoritmo de Sugiyama para códigos skew RS\xspace}
\newcommand{\miNombre}{Guillermo Galindo Ortuño\xspace}
...
\newcommand{\miTutor}{
  José Gómez Torrecillas \\ \emph{Departamento de Álgebra}
  \\\medskip

  Francisco Javier Lobillo Borrego \\ \emph{Departamento de Álgebra}
}
...
\input{capitulos/codes}
\input{capitulos/ore}
\input{capitulos/algorithm}
\input{capitulos/implementation}
