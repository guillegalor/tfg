...
\date{\today}
\title{Algoritmo de Sugiyama para códigos skew RS}
...
\input{src/Maths/codes.tex}
\input{src/Maths/ore.tex}
\input{src/Maths/algorithm.tex}
\input{src/ComputerScience/implementation.tex}
